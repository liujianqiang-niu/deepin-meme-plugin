...
预置视频均为 **H264 MP4 编码，单文件小于 50 MB**（可直接从源码仓库 `data/res/` 目录获取），符合 GitHub 仓库文件大小限制，clone 后开箱即用、无需解压：

| 文件 | 分辨率 | 大小 |
|---|---|---|
| 【哲风壁纸】二次元-仙鹤_3840x2160.mp4 | 3840 × 2160 | 10.4 MB |
| 【哲风壁纸】二次元-动态壁纸_3840x2160.mp4 | 3840 × 2160 | 5.3 MB |
| 【哲风壁纸】亡灵-动态-头骨.mp4 | 1920 × 1080 | 9.6 MB |
| 【哲风壁纸】光之巨人-光线技能_1920x1080.mp4 | 1920 × 1080 | 5.9 MB |
| 【哲风壁纸】动态-奇幻-恐怖.mp4 | 1920 × 1080 | 4.1 MB |

> 打包时这些视频随 `deepin-meme-plugin-data` 包安装至 `/usr/share/deepin-meme-wallpapers/`，构建流程直接从 `data/res/` 使用现成文件，不受仓库历史大小影响。
